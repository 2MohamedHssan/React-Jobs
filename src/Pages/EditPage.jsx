...
const EditPage = ({ updatingsubmite }) => {
  const jobs = useLoaderData()
  const Navigate = useNavigate();
  const [id, SetId] = useState(jobs.id);
  ...
  const [companydescription, SetCompanydescription] = useState(jobs.company.description);
  const [companycontactEmail, SetCompanycontactEmail] = useState(jobs.company.contactEmail);
  const [companycontactPhone, SetCompanycontactPhone] = useState(jobs.company.contactPhone);
